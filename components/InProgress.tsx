    ...
    <section className="relative py-20 border-t border-white/5">
      <div className="max-w-6xl mx-auto px-6">
        <motion.div
          ...
          className="relative bg-[#0a0a0d] border border-white/5 p-8 sm:p-10"
        >
          {/* Animated top border */}
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
            <div className="flex-1">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-zinc-100 tracking-tight mb-4">
            ...
            <div className="sm:text-right shrink-0">
              <p className="text-xs tracking-wider uppercase text-zinc-700 mb-2">
                Stack
              </p>
              <div className="flex flex-wrap sm:flex-col gap-1.5 sm:items-end">
                {["TypeScript", "PostgreSQL", "OpenAI API", "Next.js"].map(
                  (tech) => (
                    <span
                      key={tech}
                      className="text-xs text-zinc-600 border border-white/5 px-2 py-0.5 font-mono"
                    >
                      {tech}
                    </span>
                  )
